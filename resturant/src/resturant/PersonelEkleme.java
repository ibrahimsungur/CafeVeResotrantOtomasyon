...
public class PersonelEkleme extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Personel Ekleme");
        ...
        jLabel7.setText("Eklenecek Personel Bilgisi");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            ...
            String evtelno  = jTextField3.getText();
            String ceptelno = jTextField4.getText();
            String aciklama = jTextField5.getText();
          ...
          if(!jTextField1.getText().isEmpty() && !jTextField2.getText().isEmpty() && !jTextField4.getText().isEmpty() && !jTextField5.getText().isEmpty()&& !jTextField6.getText().isEmpty())
        {
            ...
            db.personelEkle("PersonelTablo", values);
